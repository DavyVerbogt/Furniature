...
public class buttonTags extends Button {
    private static final ResourceLocation TABS = new ResourceLocation(Furniature.MOD_ID, "textures/gui/creative_inventory/tabs.png");

    private final CreativeFilter.TagFilter category;
